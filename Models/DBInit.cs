...
public static class DBInit
{
    public static void Seed(IApplicationBuilder app)
    {
        ...
        {
            var items = new List<Item> // Add items to the database
            {
                new Item
                {
                    Name = "Pizza",
        ...
        if (!context.Customers.Any()) // Add customers to the database
        {
        ...
        if (!context.Orders.Any()) // Add orders to the database
        {
        ...
        if (!context.OrderItems.Any()) // Add order items to the database
        {
